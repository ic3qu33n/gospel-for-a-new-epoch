...
checkelfpass db 'File is an ELF!', 0
check64pass db 'File is an ELFCLASS64!', 0
checkarchpass db 'File is compiled for x86-64!', 0
...
;****************************************************************************************
	...
	xor rcx, rcx	
	lea r13,  [r14 + 600 + linuxdirent.d_nameq]
	call _write
	jmp check_file
